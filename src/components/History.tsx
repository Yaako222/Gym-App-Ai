                      ...
                      <>
                        <div className="flex justify-between items-start mb-2">
                          ...
                          <div className="flex gap-1 opacity-0 group-hover:opacity-100 transition-all">
                            ...
                            <button onClick={() => setLogToDelete(log.id)} className="text-slate-500 hover:text-[#FF0050] p-1"><Trash2 className="w-4 h-4" /></button>
                          </div>
                        </div>
      ...
      {logToDelete && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          <div className="bg-[#1e293b] rounded-2xl p-6 max-w-sm w-full border border-[#FF0050]/30 shadow-[0_0_30px_rgba(255,0,80,0.15)]">
            ...
            <p className="text-slate-400 mb-6">Möchtest du diesen Eintrag wirklich löschen? Diese Aktion kann nicht rückgängig gemacht werden.</p>

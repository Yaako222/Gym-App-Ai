...
import { Dumbbell, Plus, Search, Sun, Calendar, BarChart2, MessageSquare, Gift, LogOut, Users, Settings as SettingsIcon } from 'lucide-react';
...
function App() {
  const [activeTab, setActiveTab] = useState<'today' | 'dashboard' | 'analytics' | 'history' | 'friends' | 'chat' | 'wrapped' | 'settings'>('today');
      ...
      <header className="sticky top-0 z-30 bg-[#0f172a]/80 backdrop-blur-md border-b border-[#FF0050]/30 shadow-[0_0_20px_rgba(255,0,80,0.15)]">
        <div className="max-w-5xl mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2 text-[#FF0050] drop-shadow-[0_0_8px_rgba(255,0,80,0.8)]">
            ...
            <h1 className="text-xl font-bold tracking-tight text-white hidden sm:block text-glow-pink">GymTracker<span className="text-[#FF0050]">.AI</span></h1>
          </div>
          <div className="flex items-center gap-4">
            <nav className="flex gap-1 bg-white/5 p-1 rounded-full border border-white/10 overflow-x-auto hide-scrollbar shadow-[inset_0_0_10px_rgba(255,255,255,0.05)]">
              <button
